...
namespace Chudisoft.InputControls
{
    ...
    public partial class DropDownControlText : UserControl
    {
        //Fields
        ...
        //Constructor
        public DropDownControlText()
        {
            InitializeComponent();
            AdjustComboBoxDimensions();

            toolTip1.SetToolTip(txt, toolTip1.GetToolTip(this));
        }
        ...
        {
            cmbList.Width = txt.Width;
            cmbList.Location = new Point()
            {
                X = this.Width - this.Padding.Right - cmbList.Width,
                Y = txt.Bottom - cmbList.Height
            };
        }
        ...
        private void ComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //Refresh text
            txt.Text = cmbList.Text;
            if (cmbList.SelectedIndex == -1) txt.Clear();
        }
        //-> Items actions
