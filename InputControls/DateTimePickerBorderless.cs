...
namespace Chudisoft.InputControls
{
    public class DateTimePickerBorderless : System.Windows.Forms.DateTimePicker
    {
        private Color _disabled_back_color;
        private Image _image;
        private Color _text_color = Color.Black;

        public DateTimePickerBorderless() : base()
        {
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            var ddb_rect = new Rectangle(ClientRectangle.Width - 17, 0, 17, ClientRectangle.Height);
            // Background brush
            Brush bb;
            ...
            if (_image is object)
            {
                var im_rect = new Rectangle(ClientRectangle.Width - 40, 4, ClientRectangle.Height - 8, ClientRectangle.Height - 8);
